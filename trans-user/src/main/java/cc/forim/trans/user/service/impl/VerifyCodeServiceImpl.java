...
import cc.forim.trans.user.infra.enums.CacheKey;
import cc.forim.trans.user.infra.pending.TaskPendingHolder;
...
import static cc.forim.trans.user.infra.enums.CommonConstant.COLON;
import static cc.forim.trans.user.infra.enums.CommonConstant.STRING;
import static cc.forim.trans.user.infra.enums.EmailContentEnum.VERIFY_CODE_TO_REGISTER;
...
public class VerifyCodeServiceImpl implements VerifyCodeService {
    ...
    private void saveVerifyCode(String account, String code) {
        ...
        // 验证码存Redis，格式：trans:user:register:verify:账号名:string
    ...
    public Boolean ifRegisterVerifyCodeValid(String account, String code) {
        return StrUtil.equals(code, getGeneratedVerifyCode(account));
    }
}